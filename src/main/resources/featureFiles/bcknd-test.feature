Feature: Operating on pet store with API
  ...
  Scenario: delete an existing pet
    Given POST request is made to https://petstore3.swagger.io/api/v3/pet endpoint with the body C:\Testy\CLXInterview\src\main\resources\jsons\petBodyForDelete.json
